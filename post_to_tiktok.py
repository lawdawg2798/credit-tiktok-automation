...
Content Posting API (requires an approved app + OAuth token), flags it as
AI-generated per TikTok's disclosure requirement, and moves the record to a
local 'content_posted' folder. All files live in one flat directory.

Run:  python post_to_tiktok.py
"""
import json
import os
import random
